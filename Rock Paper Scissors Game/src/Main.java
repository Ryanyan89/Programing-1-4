...
public class Main {
    public static void main(String[] args) {
        ...
        playerChoice = scan.next();
            ...
            //possible outcomes
            if (playerChoice.equals(r) && computerNumber.equals(r)) {
                System.out.println("You chose Rock");
                System.out.println("Computer chose Rock");
                System.out.println("Tie.");
            } else if (playerChoice.equals(p) && computerNumber.equals(p)) {
                System.out.println("You chose Paper");
                System.out.println("Computer chose Paper");
                System.out.println("Tie.");
            } else if (playerChoice.equals(s) && computerNumber.equals(s)) {
                System.out.println("You chose Scissors");
                System.out.println("Computer chose Scissors");
                System.out.println("Tie.");
                System.out.println("Your score is: " + playerWin);
                System.out.println("The computer's score is: " + computerWin);
            } else if (playerChoice.equals(r) && computerNumber.equals(p)) {
                System.out.println("You chose Rock");
                System.out.println("Computer chose Paper");
                System.out.println("You lost.");
                computerWin = computerWin + 1;
            } else if (playerChoice.equals(p) && computerNumber.equals(r)) {
                System.out.println("You chose Paper");
                System.out.println("Computer chose Rock");
                System.out.println("You Win!");
                playerWin = playerWin + 1;
            } else if (playerChoice.equals(s) && computerNumber.equals(r)) {
                System.out.println("You chose Scissors");
                System.out.println("Computer chose Rock");
                System.out.println("You lost.");
                computerWin = computerWin + 1;
            } else if (playerChoice.equals(r) && computerNumber.equals(s)) {
                System.out.println("You chose Rock");
                System.out.println("Computer chose Scissors");
                System.out.println("You win!");
                playerWin = playerWin + 1;
            } else if (playerChoice.equals(s) && computerNumber.equals(p)) {
                System.out.println("You chose Scissors");
                System.out.println("Computer chose Paper");
                System.out.println("You win!");
                playerWin = playerWin + 1;
            } else if (playerChoice.equals(p) && computerNumber.equals(s)) {
                System.out.println("You chose Paper");
                System.out.println("Computer chose Scissors");
                System.out.println("You lost.");
                computerWin = computerWin + 1;
